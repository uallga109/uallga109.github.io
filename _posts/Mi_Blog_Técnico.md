...
date: 2026-03-12
author: uallga109
categories: [DevOps, SoftwareEngineering]
...
## 🎯 El Desafío Técnico
[cite_start]En el marco del curso **HMIS 2026**, nuestro equipo, **EscuderoGarcia**, se enfrentó al reto de desarrollar un blog colaborativo que no solo cumpliera con los requisitos funcionales, sino que sirviera como un caso de estudio real sobre **automatización y despliegue**[cite: 1, 9]. 

[cite_start]Mi misión principal fue liderar la integración del flujo de trabajo y asegurar que cada línea de código subida por mis compañeros pasara por un proceso de validación riguroso antes de ver la luz en producción[cite: 332, 40].
...
* [cite_start]**Generador Estático (SSG):** Jekyll, por su robustez y natividad con el ecosistema de GitHub[cite: 12, 61].
* [cite_start]**Control de Versiones:** Git, bajo la metodología **GitHub Flow**[cite: 40, 62].
* [cite_start]**Infraestructura Cloud:** Despliegue multicanal utilizando **Azure Static Web Apps** y **Azure Virtual Machines** con Nginx para balanceo y redundancia[cite: 84, 86, 88].
...
2.  [cite_start]**Feature Branches:** Cada funcionalidad (páginas de miembros, entradas del blog) nació en su propia rama aislada[cite: 44].
3.  [cite_start]**Pull Requests & Peer Review:** El responsable del repositorio validó cada cambio antes de la fusión, garantizando la calidad técnica[cite: 45].
